                ...
                <div class="lg:col-span-7 group cursor-pointer">
                    <div class="relative rounded-2xl overflow-hidden h-80 shadow-sm">
                        <img src="{{ asset('storage/' . $mostPopular->images) }}" alt="{{ $mostPopular->title }}"
                            width="300" height="169" fetchpriority="high" loading="eager"
                        ...
                        <div class="absolute bottom-0 p-6 w-full">
                            ...
                            <div class="flex items-center gap-4 text-gray-300 text-xs">
                                ...
                                <span class="flex items-center gap-1.5">
                                    <svg aria-label="komentar artikel ini" role="img" class="w-5 h-5" fill="none"
                                ...
                                <span class="flex items-center gap-1.5">
                                    <svg aria-label="views artikel ini" class="w-4 h-4 text-gray-400" fill="none"
                                ...
                                <a href="{{ route('web.show', $mostPopular->slug) }}"
                                    class="ml-auto text-white font-bold hover:text-red-400 transition-colors" wire:navigate>
