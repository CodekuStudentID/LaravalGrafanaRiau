<div class="max-w-7xl mx-auto py-12 px-4">
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 justify-items-center">
        @foreach($profiles as $profile)
            <div class="relative bg-white border border-gray-100 rounded-2xl overflow-hidden hover:shadow-2xl hover:border-green-500/40 transition-all duration-500 flex flex-row h-60 shadow-sm w-full max-w-md group">

                {{-- BACKGROUND PETA INDONESIA --}}
                <div class="absolute inset-0">
                    <img src="{{ asset('img/peta.png') }}"
                         alt="Peta Indonesia"
                         class="w-full h-full object-cover opacity-[0.09] grayscale group-hover:opacity-[0.1] transition-all duration-500">
                </div>
                ...
                {{-- LEFT SIDE --}}
                <div class="w-[38%] bg-gradient-to-b from-green-50/90 to-white/80 p-4 flex flex-col items-center justify-between border-r border-gray-50 relative z-10">
                    ...
                    <div class="text-center w-full">
                        <p class="text-[8px] font-black text-green-800 uppercase tracking-[0.2em] leading-none mb-1">
                            OFFICIAL ID
                        </p>
                    ...
                    <div>
                        <div class="flex justify-between items-start border-b border-gray-100 pb-2 mb-3">
                            ...
                            <div class="text-right flex-shrink-0 ml-2">
                                <span class="text-xl font-black text-gray-800 leading-none block">
                        ...
                        <div class="grid grid-cols-2 gap-y-2.5 gap-x-2">
                            ...
                            <div class="flex flex-col">
                                ...
                                <span class="text-[10px] font-bold text-gray-700 uppercase leading-none">
